        ...
        <div class="news-articles">
            ...
            <article class="article-card">
                ...
                <div class="article-image">
                    <img class="img-fluid" src="/img/actus/actus1.jpg" alt="Accompagnement"
            ...
            <article class="article-card">
                <!-- <div class="article-image" style="background-image: url('https://via.placeholder.com/600x400')"></div> -->
                <div class="article-image">
                    <img class="img-fluid" src="/img/actus/actus2.jpeg" alt="Accompagnement"
                    style="object-fit: cover; width: 400px; height: 200px;">
                </div>
                <div class="article-content">
            ...
            <article class="article-card">
                <!-- <div class="article-image" style="background-image: url('https://via.placeholder.com/600x400')"></div> -->
                <div class="article-image">
                    <img class="img-fluid" src="/img/actus/actus3.jpg" alt="Accompagnement"
                    style="object-fit: cover; width: 400px; height: 200px;">
                </div>
                <div class="article-content">
            ...
            <article class="article-card">
                <!-- <div class="article-image" style="background-image: url('https://via.placeholder.com/600x400')"></div> -->
                <div class="article-image">
                    <img class="img-fluid" src="/img/actus/actus4.jpeg" alt="Accompagnement"
                    style="object-fit: cover; width: 400px; height: 200px;">
                </div>
                <div class="article-content">
            ...
            <article class="article-card">
                <!-- <div class="article-image" style="background-image: url('https://via.placeholder.com/600x400')"></div> -->
                <div class="article-image">
                    <img class="img-fluid" src="/img/actus/actus5.jpeg" alt="Accompagnement"
                    style="object-fit: cover; width: 400px; height: 200px;">
                </div>
                <div class="article-content">
            ...
            <article class="article-card">
                <!-- <div class="article-image" style="background-image: url('https://via.placeholder.com/600x400')"></div> -->
                <div class="article-image">
                    <img class="img-fluid" src="/img/actus/actus6.jpg" alt="Accompagnement"
                    style="object-fit: cover; width: 400px; height: 200px;">
                </div>
                <div class="article-content">
